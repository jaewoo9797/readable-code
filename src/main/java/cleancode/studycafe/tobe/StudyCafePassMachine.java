...
public class StudyCafePassMachine {
    ...
    public StudyCafePassMachine(SeatPassProvider seatPathProvider, LockerPassProvider lockerPathProvider) {
        this.seatPassProvider = seatPathProvider;
        this.lockerPassProvider = lockerPathProvider;
    }
